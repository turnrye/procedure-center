...
if [ "$TRAVIS_BRANCH" == "master" ] && [ "$TRAVIS_PULL_REQUEST" == "false" ]; then
  ionic build ios --device --release --codeSignIdentity="iPhone Distribution" --provisioningProfile="a73a9174-4f25-476a-920a-da703cfd6ba4" --developmentTeam="8HR7TM5TD3" --packageType="app-store" #Make the build
